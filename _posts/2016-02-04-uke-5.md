...
Gruppen har valgt å dele seg inn i to deler, slik at hver del kan spesialisere seg mer inn mot ett område. Det er ikke noe poeng i at 5 stykker sitter å knoter med React, og/eller at alle 5 skal sette seg dyp inn i det bakenforliggende systemet hos kunde. 
...
> Det vil være best for gruppen at vi deler oss inn, slik at vi fordeler ressursene våres i større grad. Inndelingen har tatt hensyn til alles preferanser, og både jeg og Fredrick er spente på å sette oss inn i systemet hos kunde.
...
Backend Boys har sett mye mer på Swagger og hvordan man genererer backend ut ifra JSON. De venter fortsatt på VPN for tilgang til det interne nettverket hos kunde, da det ligger en Maven-dependency på prosjektet de prøver å generere.
